 ...
 */
@Transactional
public class TopicImpl implements TopicFacade, OrderService {
	...
	//文章
	public List getTopicByNativeId(String nativeId) {
		return this.topicDao.getTopicByNativeId(nativeId);
	}
	//文章
